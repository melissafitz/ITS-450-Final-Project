...
<form action="add_specific_coffees.php" method="post" accept-charset="utf-8">
	...
	<fieldset><legend>Fill out the form to add game products to the site.</legend>
		
		<div class="field"><label for="category"><strong>Game Type</strong></label><br />
...
// Need the available grind options:
		$grinds = '<option value="limitedEdition">Limited Edition</option><option value="regular">Regular</option>';
		
		
		

		// Need the caffeinated/decaffeinated options:
		$caf_decaf = '<option value="boardGames">Board Games</option><option value="other">Other</option>';
