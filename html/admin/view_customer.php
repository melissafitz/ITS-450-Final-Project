...
if (mysqli_num_rows($r) > 0) { // Display the order info:
	...
	echo "<p><strong>Customer Name</strong>: {$row['name']}<br /><strong>Customer Address</strong>: {$row['address']} <br /><strong>Customer Email</strong>: {$row['email']}<br /><strong>Customer Phone</strong>: {$row['phone']}<br /></p>";
